...
/**
 * Run Python script file with command-line arguments
 */
export async function runPythonFile(request: ExecRequest): Promise<ExecResult> {
    ...
    try {
        ...
        return {
            ...
            error: {
                type: 'ExecutionFailed',
                message: `Failed to execute Python file: ${error.message}`
            }
        };
    }
}
